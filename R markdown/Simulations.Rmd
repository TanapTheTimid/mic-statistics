...
```{r}
relationships <- c("positive_linear", "negative_linear", "no_relationship", "polynomial", "sinusoidal", "ellipsoid")
...
ggsave("ArtificialDatasetsNew11.png", plot = p, dpi = 300)
```
...
ggsave("ArtificialDatasetsDistCorr.png", plot = p, dpi = 300)
```
